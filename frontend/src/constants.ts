...
export const ICONS = {
  ...
  CheckCircle: () =>
    React.createElement(
      'svg',
      {
        ...
        viewBox: '0 0 24 24',
        fill: 'currentColor',
        className: 'w-5 h-5 text-ayur-leaf',
      },
      React.createElement('path', {
        fillRule: 'evenodd',
  ...
  Bowl: () =>
    React.createElement(
      ...
      React.createElement('path', {
        fillRule: 'evenodd',
        d: 'M12.378 1.602a.75.75 0 00-.756 0 2.25 2.25 0 00-.272 2.912c-.349.276-.731.504-1.138.668a6.75 6.75 0 00-5.212 6.292c0 2.15.862 4.143 2.275 5.635a.75.75 0 101.09-1.03 5.25 5.25 0 01-1.865-3.85c0-1.78.897-3.353 2.27-4.331a3.75 3.75 0 014.462 0c1.372.978 2.27 2.551 2.27 4.331 0 1.44-.575 2.775-1.523 3.766a.75.75 0 101.09 1.03 6.75 6.75 0 002.275-5.635 6.75 6.75 0 00-5.212-6.292c-.407-.164-.79-.392-1.138-.668a2.25 2.25 0 00-.272-2.912z',
        clipRule: 'evenodd',
      }),
      React.createElement('path', {
        d: 'M4.103 14.142A9.763 9.763 0 003.264 15.2C1.65 17.653 2.593 21 6.232 21h11.536c3.64 0 4.583-3.347 2.968-5.799a9.768 9.768 0 00-.84-.98 8.24 8.24 0 01-1.554 2.872 3.75 3.75 0 01-3.39 1.407H9.048a3.75 3.75 0 01-3.39-1.407 8.24 8.24 0 01-1.554-2.873z',
      })
    ),
};
